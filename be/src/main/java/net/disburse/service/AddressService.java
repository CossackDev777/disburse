...
import net.disburse.model.*;
import net.disburse.repository.*;
...
public class AddressService {
    ...
    public AddressService(AddressRepository addressRepository, StablecoinRepository stablecoinRepository, BalanceRepository balanceRepository, TransactionRepository transactionRepository, UserRepository userRepository, JDBCRepository jdbcRepository) {
    ...
    public boolean addNewAddress(String address, String nickname, Chain chain) {
        try {
    ...
    public List<Map<String, Object>> getAllBalancesForUser(Integer userId) {
        ...
        List<Long> addressIds = jdbcRepository.getAddressByUserId(userId);
        List<Address> addresses = addressRepository.findAllById(addressIds);

        List<Balance> balances = balanceRepository.findByAddressIn(addresses);
        ...
        for (Address address : addresses) {
            ...
            addressPortfolio.put("chain", address.getChain());
